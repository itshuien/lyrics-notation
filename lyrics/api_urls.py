...
urlpatterns = [
    ...
    path('lyric_notations/<int:pk>', LyricNotationViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'})),
    path('phonetic_notations/<int:pk>', PhoneticNotationViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'})),
]